...
/**
 * Whole-organization documents — the СӨХ's charter, general meeting minutes,
 * contracts and similar paperwork that belongs to the association as a whole, not to
 * any one building. Reuses the exact same Document schema, upload/update modals and
 * table columns/filters as PropertyDocuments (apps/condo/domains/property/components/
 * PropertyDocuments/PropertyDocuments.tsx) — the only difference is the query/create
 * calls omit `property` entirely instead of connecting one.
 */
